...
public class DibujosBasicos {
	...
	public static void pintarRectangulo(Graphics g, int ancho, int alto, int posicionX, int posicionY)
	{
	...
	public static void pintarImagenJugador(Graphics2D g, Sprites sprite, Jugador jugador) {
		g.drawImage(sprite.imagen, jugador.getPosicion().x, jugador.getPosicion().y,
				sprite.introducirImagenesArray(sprite.imagen), null);
	}

	public static void pintarImagenSpawnEnemigo(Graphics2D g, Sprites sprite, SpawnEnemigo enemigo) {
		g.drawImage(sprite.imagen, enemigo.posicionSpawn().x, enemigo.posicionSpawn().y,
				sprite.introducirImagenesArray(sprite.imagen), null);
	}

	public static void pintarImagenEnemigo(Graphics2D g, Sprites sprite, Enemigo enemigo) {
		g.drawImage(sprite.imagen, enemigo.getPosicion().x, enemigo.getPosicion().y,
				sprite.introducirImagenesArray(sprite.imagen), null);
	}

	public static void pintarImagenArmas(Graphics2D g, Sprites sprite, Armas armas) {

		g.drawImage(sprite.imagen, armas.posicion.x, armas.posicion.y, sprite.introducirImagenesArray(sprite.imagen),
				null);
	...
	public static void pintarImagenMapa(Graphics2D g, SpritesMapa sprite, Mapa mapa) {
		g.drawImage(sprite.imagen, mapa.getPosicion().x, mapa.getPosicion().y,
				sprite.introducirImagenesArrayMapa(sprite.imagen), null);
	}
	...
	public static void pintarRectanguloColor(Graphics g, int ancho, int alto, int posicionX, int posicionY, Color color)// Color
																														// color
	{
		g.setColor(color);
		g.fillRect(posicionX, posicionY, ancho, alto);
	...
	public static void pintarBoton(Graphics g, int ancho, int alto, int posicionX, int posicionY, Color color)// Color
																												// color
	{
